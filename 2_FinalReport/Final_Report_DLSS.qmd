...
Spectral embedding chosen by eigenvalue gap. 
...
For the network we remove nodes with total degree(k)$k ≤ 1$, so the leaves of the network. 
...
\begin{figure}[H]
    \begin{subfigure}{0.3\textwidth} 
        \centering
        \includegraphics[width=\textwidth]{Images/enhanced_improved_gnn_data_quantile_Target_QC_aggcat.png} %Path to images 
        \label{fig:Multilayer Perceptron}
    \end{subfigure}
    \hfill 
    \begin{subfigure}{0.3\textwidth} 
        \centering
        \includegraphics[width=\textwidth]{Images/enhanced_residual_gcn_data_quantile_Target_QC_aggcat.png}
        \label{fig:Concolutional Graph Neural Network}
    \end{subfigure}
    \hfill 
    \begin{subfigure}{0.3\textwidth} 
        \centering
        \includegraphics[width=\textwidth]{Images/enhanced_residual_sage_data_quantile_Target_QC_aggcat.png}
...
\begin{figure}[H]
    \begin{subfigure}{0.3\textwidth} 
        \centering
        \includegraphics[width=\textwidth]{Images/enhanced_gat_data_quantile_Target_QC_aggcat.png} %Path to images 
        \label{fig:Multilayer Perceptron}
    \end{subfigure}
    \hfill 
    \begin{subfigure}{0.3\textwidth} 
        \centering
        \includegraphics[width=\textwidth]{Images/enhanced_mlp_data_quantile_Target_QC_aggcat.png}
        \label{fig:Concolutional Graph Neural Network}
    \end{subfigure}
    \hfill 
    \begin{subfigure}{0.3\textwidth} 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Images/Result_GNN_Metrics.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=5cm, keepaspectratio]{Images/Confusion_GNN_ShareOfClass.png}
