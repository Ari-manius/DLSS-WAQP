...
-   some hints for network structure and position being related article quality (MLP with performed better), which by a few percentage points is already remarkable, as these buffs have to be stacked in order to provide meaningful improvements
