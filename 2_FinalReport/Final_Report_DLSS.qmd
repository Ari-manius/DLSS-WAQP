...
header-includes:
  ...
  - \postdate{\begin{figure}[H]
      \centering
      \includegraphics[width=.9\textwidth]{Images/wiki_network_clean.png}
    \end{figure}
    \end{center}} 
...
\begin{figure}[H]
    ...
    \caption{Feature correlation heatmap and links vs references scatter plot}
...
\begin{figure}[H]
    ...
    \caption{Distribution of numerical features across the dataset}
